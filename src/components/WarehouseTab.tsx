...
import { 
  ...
  Tag, DollarSign, Layers, Info, Archive
} from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6 pb-24">
      <div className="flex items-center justify-between mb-6 px-1">
        ...
        >
          ...
          <span className="text-xs font-bold pr-1">Aggiungi</span>
        </button>
      </div>
        ...
        {(isAdding || editingId) && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Categoria (Opzionale)</label>
                <div className="relative">
                  <Layers className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                  <input 
                    type="text"
                    list="categorie-esistenti"
                    placeholder="Es: Pods, Kit..."
