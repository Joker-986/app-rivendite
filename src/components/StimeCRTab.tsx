...
const StimeCRTab: React.FC<StimeCRTabProps> = ({
  rubrica,
  crmAnagrafiche,
  stores,
  giroVisite,
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center overflow-hidden p-0.5 shadow-sm shrink-0">
                <img src="/CR.jpg" alt="CR" className="w-full h-full object-cover rounded-md" />
              </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3 relative">
        {filteredAndSortedItems.length === 0 ? (
          <div className="bg-white p-8 rounded-2xl text-center border border-slate-100 shadow-sm mt-4">
            <img src="/CR.jpg" alt="CR" className="w-12 h-12 mx-auto mb-3 opacity-40 grayscale rounded-xl" />
            ...
            <p className="text-xs text-slate-400 mt-1">
              {searchTerm 
                ...
                : 'Gli ordini possono essere inseriti nella scheda della rivendita'}
            </p>
          </div>
        ) : (
          <>
                  ...
                  <div className="flex justify-between items-start gap-3 mb-2.5">
                    ...
                    <div className="flex items-start shrink-0">
                      <button 
                        ...
                        title="Vedi cronologia ordini CR"
                      >
            ...
            <div className="bg-slate-800 p-4 flex justify-between items-start shrink-0">
              <div className="min-w-0 pr-4">
                ...
                <p className="text-emerald-400 text-xs font-bold uppercase mt-1 flex items-center gap-1">
                  <img src="/CR.jpg" alt="CR" className="w-3.5 h-3.5 rounded-sm object-cover" />
                        ...
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-slate-400">
                              {itemCount > 0 ? `${itemCount} voci carrello` : (ord.note || 'Ordine Magazzino')}
                            </p>
                          </div>
                        </div>
